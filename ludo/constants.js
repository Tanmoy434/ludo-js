...
export const ALL_PLAYERS = ["Player1", "Player2", "Player3", "Player4"];
export let ACTIVE_PLAYERS = ["Player1", "Player2"]; // default 2 players
export let AI_PLAYERS = [];

export function setActivePlayers(count) {
    AI_PLAYERS = [];
    switch (count) {
        case 4:
...
export const BASE_POSITIONS = {
    ...
    Player3: [700,701,702,703],
    Player4: [800,801,802,803],
};
...
export const HOME_ENTRANCE = {
    ...
    Player3: [300,301,302,303,304],
    Player4: [400,401,402,403,404]
};
...
export function setAIPlayers(aiList) {
  AI_PLAYERS = aiList;
}
